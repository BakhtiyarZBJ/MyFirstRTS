...
public class Magic : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        uiObject = GameObject.FindGameObjectWithTag("CanvasMid").transform.Find("Magic").gameObject;
        ...
        magic1 = uiObject.transform.parent.parent.Find("Magic").Find("ButtonMagic1").GetComponent<Button>();
        magic2 = uiObject.transform.parent.parent.Find("Magic").Find("ButtonMagic2").GetComponent<Button>();
        magic3 = uiObject.transform.parent.parent.Find("Magic").Find("ButtonMagic3").GetComponent<Button>();

        magic1Image = magic1.transform.Find("Reload").GetComponent<Image>();
        magic2Image = magic2.transform.Find("Reload").GetComponent<Image>();
        magic3Image = magic3.transform.Find("Reload").GetComponent<Image>();
