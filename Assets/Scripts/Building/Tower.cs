...
public class Tower : MonoBehaviour 
{
    ...
    void Awake ()
	{
        ...
        uiObject = GameObject.FindGameObjectWithTag("CanvasMid").transform.Find("Tower").gameObject;
        ...
        damageText = uiObject.transform.Find("TextStats").Find("TextDamageValue").GetComponent<Text>();
